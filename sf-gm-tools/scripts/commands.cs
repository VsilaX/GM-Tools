...
function sfGMobj()
{
	%obj = SFGMGuiobj.getSelected();
	%objText = SFGMGuiobj.getText();
...
function sfGMscale()
{
	%scale = SFGMGuiscale.getSelected();
	%scaleText = SFGMGuiscale.getText();
